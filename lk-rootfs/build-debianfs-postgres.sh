...
ROOTFS_SIZE_MB=4096
ROOTFS_IMAGE="debian-postgres.ext4"
...
# --- STEP 1: DEFINE THE OS (Debian PostgreSQL) ---
cat >"${BUILD_DIR}/Dockerfile" <<'EOF'
FROM debian:bookworm-slim
ENV DEBIAN_FRONTEND=noninteractive

# 1. Install Core Dependencies & PostgreSQL
...
# 2. Configure PostgreSQL to listen on 0.0.0.0
# Debian Bookworm uses PostgreSQL 15 by default
