...
# --- STEP 1: DEFINE THE OS (Node.js Debian) ---
...
# We download the official linux-x64 binary to keep it lightweight
RUN curl -fsSL https://nodejs.org/dist/v22.13.1/node-v22.13.1-linux-x64.tar.xz | tar -xJ -C /usr/local --strip-components=1
...
# 4. Create a simple "Hello World" app to test the VM
RUN mkdir -p /app
COPY index.js /app/index.js
EOF

cat >"${BUILD_DIR}/index.js" <<'APP'
...
echo "[init] Starting Node.js application..."
node /app/index.js > /var/log/node-app.log 2>&1 &
